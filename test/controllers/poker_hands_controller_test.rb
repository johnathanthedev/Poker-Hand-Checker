...
class PokerHandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poker_hand" do
    assert_difference('PokerHand.count') do
      post poker_hands_url, params: { poker_hand: { cards: @poker_hand.cards, is_ranking_type: @poker_hand.is_ranking_type, rank_no: @poker_hand.rank_no, ranking_type: @poker_hand.ranking_type } }
    end
  ...
  test "should update poker_hand" do
    patch poker_hand_url(@poker_hand), params: { poker_hand: { cards: @poker_hand.cards, is_ranking_type: @poker_hand.is_ranking_type, rank_no: @poker_hand.rank_no, ranking_type: @poker_hand.ranking_type } }
