...
class PokerHandzsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create poker_handz' do
    assert_difference('PokerHandz.count') do
      post poker_handzs_url,
           params: { poker_handz: { cards: @poker_handz.cards, is_ranking_type: @poker_handz.is_ranking_type,
                                    rank_no: @poker_handz.rank_no, ranking_type: @poker_handz.ranking_type } }
    end
  ...
  test 'should update poker_handz' do
    patch poker_handz_url(@poker_handz),
          params: { poker_handz: { cards: @poker_handz.cards, is_ranking_type: @poker_handz.is_ranking_type,
                                   rank_no: @poker_handz.rank_no, ranking_type: @poker_handz.ranking_type } }
